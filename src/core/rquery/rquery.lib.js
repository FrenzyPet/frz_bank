...
class RQuery {
	...
	/**
	 * Adds classes to the current element.
	 * @param {string | string[]} classNames - Class name (array of class names) to add to the element.
	 * @returns {RQuery} The current RQuery instance for chaining.
	 */
	addClass(classNames) {
	...
	/**
	 * Removes classes from the current element.
	 * @param {string | string[]} classNames - Class name (array of class names) to remove from the element.
	 * @returns {RQuery} The current RQuery instance for chaining.
	 */
	...
	/**
	 * Attach click event listener ti the selected element
	 ...
	 * @param {function(Event): void} [options.onInput] - The events listeners for the input events.
	 * @param {object} [options.rest] - Optional attributes to set on the input element.
	 * @returns {RQuery} The current RQuery instance fot chaining.
	 */
	input({ onInput, ...rest }) {
